...
```
  ╔══════════════════════════════════════════════════════════╗
  ║   🛠️  SERVER SETUP — Unified Management                  ║
  ╚══════════════════════════════════════════════════════════╝

  Remnawave Panel:  ● установлена
...
Статусы: `● запущен` — работает, `◐ остановлен` — установлен но не запущен, `○ не установлен` — отсутствует.
...
```
  ...
  6) Пользователи и ссылки
  7) Перенести на другой сервер
  0) Назад
```
